/* Scanner.flex - Roteiro 8: Regra while, for, do-while
 *
 * Mudancas em relacao ao Roteiro 7:
 *   - Adicionado "for"  -> KW_FOR  (Atividade 2)
 *   - Adicionado "do"   -> KW_DO   (Atividade 3)
 *   Ambas DEVEM vir antes de {ident} para serem palavras reservadas.
 */
