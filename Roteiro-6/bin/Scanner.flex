/* Scanner.flex - Roteiro 6: Regra if
 *
 * Mudancas em relacao ao Roteiro 5:
 *   - Adicionados KW_TRUE ("true") e KW_FALSE ("false") como palavras reservadas
 *     necessario para a Atividade 2 (if(true){} e if(false){})
 *   - OP_RELACIONAL ja passava yytext() como valor String desde Roteiro 5;
 *     agora o parser efetivamente usa esse valor no switch da condicao
 */
